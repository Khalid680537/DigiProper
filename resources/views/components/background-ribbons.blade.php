...
<div aria-hidden="true" class="pointer-events-none fixed inset-0 z-0 overflow-hidden">
    {{-- Purple tint blob, top-left --}}
    <div class="absolute -top-40 -left-40 h-[44rem] w-[44rem] rounded-full bg-primary-500/25 blur-3xl"></div>

    {{-- Orange tint blob, bottom-right --}}
    <div class="absolute -bottom-40 -right-40 h-[42rem] w-[42rem] rounded-full bg-accent-400/22 blur-3xl"></div>
