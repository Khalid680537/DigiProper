...
>
    ...
    <div
        ...
        class="fixed inset-x-0 top-20 z-50 mx-auto w-full max-w-xl px-4"
    ...
    >
        <div class="overflow-hidden rounded-2xl bg-white dark:bg-gray-800 shadow-soft-lg ring-1 ring-ink-100 dark:ring-ink-800">
            {{-- Input row --}}
            <div class="flex items-center gap-3 px-4 py-3 border-b border-ink-100 dark:border-ink-800">
                ...
                <input
                    ...
                    class="flex-1 bg-transparent border-0 focus:ring-0 text-sm text-ink-800 dark:text-ink-100 placeholder-ink-400 dark:placeholder-ink-500 p-0"
                    autocomplete="off"
                    spellcheck="false"
                />
            ...
            <div class="max-h-96 overflow-y-auto py-2">
                ...
                <template x-if="query.trim() === ''">
                    <div>
                        <p class="px-4 pt-1 pb-2 text-[11px] font-semibold uppercase tracking-wide text-ink-400 dark:text-ink-500">Jump to</p>
                ...
                <template x-if="query.trim() !== ''">
                    <div>
                        <template x-if="results.length > 0">
                            <div>
                                <p class="px-4 pt-1 pb-2 text-[11px] font-semibold uppercase tracking-wide text-ink-400 dark:text-ink-500">Properties</p>
                        ...
                        <template x-if="!loading && results.length === 0">
                            <p class="px-4 py-6 text-center text-sm text-ink-400 dark:text-ink-500">
                                No properties match
            ...
            {{-- Footer hints --}}
            <div class="flex items-center justify-between gap-3 px-4 py-2 border-t border-ink-100 dark:border-ink-800 bg-surface-50 dark:bg-gray-900/40 text-[11px] text-ink-500 dark:text-ink-400">
