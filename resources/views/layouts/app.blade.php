                ...
                <a href="{{ route('dashboard') }}"
                   class="md:hidden sticky top-0 z-30 flex items-center gap-3 h-14 px-4 bg-white/90 dark:bg-gray-900/90 backdrop-blur-md border-b border-ink-100 dark:border-ink-800">
                    ...
                    <span class="inline-flex items-center gap-1">
                        <span class="font-extrabold text-base tracking-tight text-accent-600 dark:text-accent-400">Digi<span class="italic">Proper</span></span>
                        <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="h-3 w-3 -translate-y-1 text-primary-500 dark:text-primary-400">
