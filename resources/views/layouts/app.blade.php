    ...
    <body class="font-sans antialiased bg-surface-50 dark:bg-gray-950 text-ink-800 dark:text-ink-100">
        ...
        <div class="relative min-h-dvh md:flex">
            ...
            <div class="flex-1 flex flex-col min-w-0">
                ...
                <div class="md:hidden sticky top-0 z-30 flex items-center gap-3 h-14 px-4 bg-white/90 dark:bg-gray-900/90 backdrop-blur-md border-b border-ink-100 dark:border-ink-800">
